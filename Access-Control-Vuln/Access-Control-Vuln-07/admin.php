...
// Try to read header (accept correct name and common typo)
$header_original = null;
if (!empty($_SERVER['HTTP_X_ORIGINAL_URL'])) {
    $header_original = $_SERVER['HTTP_X_ORIGINAL_URL'];
} elseif (!empty($_SERVER['HTTP_X_OROGINAL_URL'])) {
    $header_original = $_SERVER['HTTP_X_OROGINAL_URL'];
}

// Only allow if X-Original-URL header is correct (for admin.php)
if ($access_admin && $header_original === '/admin.php') {
    $allowed = true;
}
...
<?php else: ?>
    ...
    <p>This is your home page. Click <strong>Admin Panel</strong> to access admin features.</p>
<?php endif; ?>
</div>
</body>
</html>
